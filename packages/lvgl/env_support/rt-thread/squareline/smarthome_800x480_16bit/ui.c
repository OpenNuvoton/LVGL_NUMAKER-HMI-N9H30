...
void ui_Home_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Footer, 46);
    ...
    lv_obj_set_style_pad_column(ui_Footer, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui_Noti_Indicator, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
